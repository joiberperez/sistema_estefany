<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="/sistema_estefany/app/home.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="/sistema_estefany/app/cliente/cliente.php" class="menu-link">
  ...
  // Recorre los enlaces y añade la clase 'active' al enlace correspondiente
